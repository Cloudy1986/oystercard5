class Oystercard
  ...
  MINIMUM_BALANCE = 1
  MINIMUM_FARE = 1
  attr_reader :balance, :entry_station, :exit_station, :journey_history #move to journey class
  ...
  def touch_out(station)
    ...
    @journey_history << { :journey_entry => @entry_station, :journey_exit => station } #move to journey class
    @entry_station = nil
    @exit_station = nil
  end
